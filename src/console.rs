...
use crate::{compute_optimal_hand, BlackjackGameError, BlackjackTable, Card, Deck, Player};
...
pub struct BlackjackTableCLI {
    deck: Deck,
    balance: f32,
    dealers_hand: DealersBlackjackHandCLI,
    n_shuffles: u32,
}
...
impl BlackjackTableCLI {
    ...
    pub fn display_playing_options(&self, options: &HashMap<i32, String>, player: &PlayerCLI) {
    ...
    // pub fn stand(&self, player: &mut PlayerCLI) {
    //     player.stand();
    ...
    // pub fn hit(&mut self, player: &mut PlayerCLI) {
    ...
    // pub fn double_down(&mut self, player: &mut PlayerCLI) {
    ...
    // pub fn split(&mut self, player: &mut PlayerCLI) {
    //     player.split(
    ...
    // pub fn deal_hand(&mut self, player: &mut PlayerCLI) {
    //     assert!(
    ...
    // pub fn finish_hand(&mut self, player: &mut PlayerCLI) {
...
impl BlackjackGameCLI {
    ...
    pub fn new(minimum_bet: u32, player: PlayerCLI, table: BlackjackTableCLI) -> BlackjackGameCLI {
        BlackjackGameCLI {
            minimum_bet,
            player,
            table,
