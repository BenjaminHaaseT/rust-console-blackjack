...
// impl DisplayablePlayersBlackjackHand for PlayersBlackjackHandCLI {
...
// // impl DisplayablePlayer for PlayerCLI {
...
//     fn display_playing_options<P: Player>(&self, options: &HashMap<i32, String>, player: &P) {
...
//     fn display_end_of_hand_state<P: Player>(
//         &self,
//         player: &P,
...
// impl BlackjackTable for ConsoleBlackjackTable {
